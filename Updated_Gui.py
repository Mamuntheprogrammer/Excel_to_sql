...
scclbtn = Button(exportbtn, text="Export CSV",textvariable=sccbtn, command=expexcel,width=20,relief=RAISED,font=('Times 10 bold'),fg='#fcf9ec',bg='#132238')
...
cclbtn = Button(exportbtn, text="Copy Data", command=expexcel,textvariable=lcbtn,width=20,relief=RAISED,font=('Times 10 bold'),fg='#fcf9ec',bg='#132238')
lcbtn.set("Copy Data")
